...
# 更加深入的性能采集
RUN sed -i "111a\        xhprof_enable(XHPROF_FLAGS_NO_BUILTINS | XHPROF_FLAGS_CPU | XHPROF_FLAGS_MEMORY);" vendor/laravel/octane/bin/swoole-server && php -l vendor/laravel/octane/bin/swoole-server
